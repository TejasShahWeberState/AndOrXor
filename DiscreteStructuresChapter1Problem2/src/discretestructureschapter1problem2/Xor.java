...
public class Xor
{
    ...
    //For this problem, you must type in 1 (true),  0(false), or get an error
    //Xor is exclusive or, meaning, in this case, exactly 1 number must be true and 1 must be false
